# Metacore 0.3.0
- Added extended function of `quiet` argument in `spec_to_metacore()` and `select_dataset` functions to suppress optional messages, notes and warnings [#122](https://github.com/atorus-research/metacore/issues/122)
