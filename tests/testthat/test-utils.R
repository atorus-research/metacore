...
test_that("check_structure function works", {
  expect_true(test %>% check_structure(a, is.character))
  expect_false(test %>% check_structure(a, is.logical))
  expect_true(test %>% check_structure(c, check_words("SpecificWord|Incorrect")))
})
