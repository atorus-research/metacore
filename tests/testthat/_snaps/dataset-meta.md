# DatasetMeta print snapshot
    ...
    Message
      ...
      > ds_vars: character [25 x 7] dataset, variable, order, mandatory, key_seq,
        core, and supp_flag
      > supp: character [0 x 4] dataset, variable, idvar, and qeval
      > value_spec: character [25 x 8] dataset, variable, origin, type, code_id,
        sig_dig, where, and derivation_id
...
# DatasetMetaDefine print snapshot
    ...
    Message
      ...
      > value_spec: character [31 x 10] dataset, variable, origin, type, code_id,
        sig_dig, where, where_label, derivation_id, and comment_id
      > var_spec: character [31 x 6] variable, length, label, type, format, and
        common
