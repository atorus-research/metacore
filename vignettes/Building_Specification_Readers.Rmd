...
ds_spec is connect to ds_vars by the 'dataset' variable and ds_vars is connected to var_spec by the 'variable' variable etc. For more information on the make-up of metacore objects please see the readme. 
...
-   order: integer controling the column order of each dataset
