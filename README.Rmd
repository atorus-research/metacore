...
You can install the current development version of metacore from [github](https://github.com/atorus-research/metacore) with:
...
-   *mandatory*: Boolean specifying whether a variable can have blank variables. From the CDISC Define-XML v2.1 documentation: Required items that have Mandatory set to "Yes" cannot have blank values. Variables in SDTM domains that have `core = "Required"` should have `mandatory = TRUE`.
