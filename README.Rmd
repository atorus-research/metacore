...
-   *core*: Core attribute indicating variable requirements. According to ADaM IG 1.3, valid values are "Required", "Conditionally Required", or "Permissible". For SDTM, values may include "Required", "Expected", or "Permissible". The field can also be NA. For more information about core see [CDISC](https://www.cdisc.org/standards/foundational/adam)
